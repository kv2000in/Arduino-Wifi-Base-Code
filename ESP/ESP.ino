...
B-O SMBUS Battery LED OFF Returns O-OFF:OK - Nov 2021 - need to change to B-O:OK
B-N SMBUS Battery LED ON Returns O-ON:OK  Nov 2021 - need to change to B-N:OK
...
K-N Head LEDs turn on Returns K-N:OK
K-O Head LEDs turn off Returns K-O:OK

O-N Tail LEDs turn on Returns K-N:OK
O-O Tail LEDs turn off Returns K-O:OK

P-N Emergency LEDs turn on Returns K-N:OK
P-O Emergency LEDs turn off Returns K-O:OK
      ...
      <!--<div class="joystick-container" id="joystick-container">
        ...
        <div class ="half" id="top-half">
            ...
            <div class = "fifty">
                ...
                <!-- headlight01 = headlight server 0 and gpio 1-->
      <button class="pwrlight" id = "headlight"></button> 
      <label class="switch">
        <input type="checkbox" id="headlightswitch" onclick='toggleheadlightswitch()'>
          <div class="slider"></div>
      </label>
                <br>
                      <button class="pwrlight" id = "taillight"></button> 
      <label class="switch">
        <input type="checkbox" id="taillightswitch" onclick='toggletaillightswitch()'>
          <div class="slider"></div>
      </label>
                <br>  
                <button class="pwrlight" id = "emergencylight"></button> 
      <label class="switch">
        <input type="checkbox" id="emergencylightswitch" onclick='toggleemergencylightswitch()'>
          <div class="slider"></div>
      </label>
                    
                
                 <button class = "controlbuttons" id="connectWS" onclick='doConnect()'>
                    Connect
                    </button>
            <button class = "controlbuttons" id="closeWS" onclick='doClose()'>
                    Close
                    </button> 
                            <button class = "controlbuttons" id="reloadfromsource" onclick='location.reload()'>
                    Reload
                    </button> 
                                            <button class = "controlbuttons" id="getbatteryinforbtn" onclick='getbatteryinfo'>
                    Battery
                    </button> 
...
function toggleheadlightswitch()
        {
            var myswitch=document.getElementById("headlightswitch");
            if (myswitch.checked){
                doSend("<K-N>");
            }
                       else {
...
function toggletaillightswitch()
        {
            var myswitch=document.getElementById("taillightswitch");
            if (myswitch.checked){
                doSend("<O-N>");
            }
                       else {
...
function toggleemergencylightswitch()
        {
            var myswitch=document.getElementById("emergencylightswitch");
            if (myswitch.checked){
                doSend("<P-N>");
            }
                       else {
...
function response_based_on_first_char(mylocalvar){
    ...
    switch(mylocalvar.split("-")[0])
    {
        ...
        break;
        /* Using O below for lights
        //Battery SMBUS LED on or off    
        case ("O"):
            document.getElementById("mylocalconsole").innerHTML=mylocalvar;
            break;
        */
        //Truck head light Leds
        case ("K"):
            
            if (mylocalvar.split("-")[1] == "N"){document.getElementById("headlight").style.backgroundColor="red";}
            if (mylocalvar.split("-")[1] == "O"){document.getElementById("headlight").style.backgroundColor="white";}
            break;
        //Truck tail light Leds
        case ("O"):
            
            if (mylocalvar.split("-")[1] == "N"){document.getElementById("taillight").style.backgroundColor="red";}
            if (mylocalvar.split("-")[1] == "O"){document.getElementById("taillight").style.backgroundColor="white";}
            break;
        //Truck emergency light Leds
        case ("P"):
            
            if (mylocalvar.split("-")[1] == "N"){document.getElementById("emergencylight").style.backgroundColor="red";}
            if (mylocalvar.split("-")[1] == "O"){document.getElementById("emergencylight").style.backgroundColor="white";}
            break;
